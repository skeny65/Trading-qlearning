...
| ID  | Par      | Estado Q                              | Flujo de cierre          | Ejecuta en Binance | SL/TP en Binance |
|-----|----------|---------------------------------------|--------------------------|-------------------|--------------------|
| 1   | SOLUSDT  | 3D: brecha_level\|pendiente_level\|d300_level (27) | Alerta close TradingView | SI (LIVE)  | NO (TradingView gestiona) |
| 2   | SOLUSDT  | 5D: regime\|momentum\|... (243)       | Alerta close TradingView | NO (LEARN_ONLY)   | N/A                |
| 3   | SOLUSDT  | 3D: entry_strength\|bar_zone\|pattern | Alerta close TradingView | NO (LEARN_ONLY)   | N/A                |
| 4   | ETHUSDT  | 3D: f1_sep\|f2_angle\|f3_d200 (27)   | Alerta close TradingView | SI (LIVE)         | NO (TradingView gestiona) |
| 5-10| -        | 3D: scaffold (27)                     | Price Poller (sl/tp)     | SI (LIVE)         | SI (Binance monitorea) |
...
|     6. STOP_MARKET closePosition=True  (SOLO si strategy 5-10) |
|     7. TAKE_PROFIT_MARKET closePosition=True  (SOLO si strategy 5-10) |
|     Estrategias 1,2,3,4: sl y tp son None (TradingView maneja cierre) |
|                                                                |
...
| BINANCE_MAX_MARGIN_PCT | 0.95 | 95% del balance disponible por trade (0.99 causa "Margin is insufficient") |
